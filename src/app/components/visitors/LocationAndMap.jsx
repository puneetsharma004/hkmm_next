        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="bg-white/10 rounded-2xl overflow-hidden border border-primary border-opacity-60 backdrop-blur-xl shadow-xl">
              <div className="aspect-video bg-gradient-to-br from-orange-100/80 to-amber-100/80">
                  ...
                  {!mapLoaded && (
                    <div className='w-full h-full grid items-center'>
                      <div className="text-center">
                        <div className="text-6xl mb-4 text-primary flex justify-center items-center animate-pulse">
                          <FaMap />
                        </div>
                        <p className="text-gray-800 font-semibold">Interactive Map</p>
                        <p className="text-gray-600 text-sm mt-2">Loading Google Maps...</p>
                      </div>
                    </div>
                  )}
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    className="px-4 py-2 bg-primary text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 flex items-center gap-2 outline-none cursor-pointer"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/10 rounded-xl p-4 border border-primary border-opacity-60 backdrop-blur-sm shadow-lg"
            >
              <h4 className="font-bold text-primary mb-2 flex items-center gap-2">
                <FaMapMarkerAlt />
                GPS Coordinates
              </h4>
              <p className="text-gray-800 font-mono text-lg">{templeLocation.gpsCoordinates}</p>
              <button className="text-primary text-sm hover:text-primary transition-colors duration-300 mt-2 flex items-center gap-1 cursor-pointer outline-none" onClick={Copy}>
                <FaCopy />
          ...
          >
            {/* Full Address */}
            <div className="bg-white/10 rounded-2xl p-8 border border-primary border-opacity-60 backdrop-blur-xl shadow-xl">
              <h3 className="text-2xl font-bold text-primary mb-6">Complete Address</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">{templeLocation.address}</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-gray-800 font-semibold">{templeLocation.pincode}</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-gray-800 font-semibold">{templeLocation.state}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {nearbyLandmarks.map((landmark, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center justify-between p-3 bg-orange-100/20 rounded-lg hover:bg-primary/80 transition-all duration-300 group"
                  >
