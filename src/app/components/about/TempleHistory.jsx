  ...
  return (
    <section className="relative py-16 px-4 overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-primary/30 to-orange-400/30 rounded-full opacity-30 blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white/10 rounded-2xl shadow-2xl p-8 border border-primary border-opacity-60 backdrop-blur-xl">
          ...
          >
            ...
            {timeline.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-start space-x-4 bg-white/10 rounded-xl p-4 border border-primary border-opacity-60 backdrop-blur-sm hover:border-primary hover:border-opacity-80 transition-all duration-300 group shadow-lg"
              >
                <div className="flex-shrink-0 w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                  {item.icon}
                </div>
        ...
        >
          <div className="bg-primary/10 rounded-2xl p-8 border border-primary/40 border-opacity-60 shadow-lg max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Living Heritage</h3>
