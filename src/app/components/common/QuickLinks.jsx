      ...
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        >
          {links.map((link, i) => (
            ...
            >
              {/* Main Card */}
              <div className="bg-white/10 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-black/80 p-6 rounded-2xl shadow-xl border border-primary dark:border-purple-400 border-opacity-60 dark:border-opacity-30 backdrop-blur-xl hover:border-saffron hover:border-opacity-80 dark:hover:border-opacity-60 hover:shadow-2xl hover:shadow-saffron/20 transition-all duration-300 h-full outline-none">
                ...
                <div className="text-center">
                  <h4 className="font-bold text-gray-800 dark:text-white text-lg mb-2 group-hover:text-primary transition-colors duration-300">
                    {link.text}
                  </h4>
        ...
        >
          <div className="bg-saffron/10 p-6 rounded-2xl border border-saffron/50 dark:border-saffron/20 border-opacity-60 dark:border-opacity-100 backdrop-blur-sm max-w-4xl mx-auto shadow-lg">
            <p className="text-gray-700 dark:text-gray-300 mb-4 flex items-center gap-2 justify-center">
              <span className="text-primary font-semibold flex items-center gap-2"><IoCall /> 24/7 Support:</span> Need immediate assistance? Our temple staff is always ready to help.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex items-center justify-center space-x-2 hover:text-primary transition-colors duration-300">
        ...
        >
          <div className="inline-flex items-center space-x-6 text-lg">
            <motion.div
              ...
              className="flex items-center space-x-2 bg-white/70 dark:bg-gray-800/70 px-4 py-2 rounded-full shadow-lg border border-primary dark:border-purple-400/30 backdrop-blur-sm"
            >
